<template>
    <div class="modal fade" id="kt_modal_update_details" ref="editUserModalRef" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_update_details_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">{{ $t('user.header.title.updateUserDetails') }}</h2>
                    <!--end::Modal title-->

                    <!--begin::Close-->
                    <div id="kt_modal_update_details_close" data-bs-dismiss="modal" class="btn btn-icon btn-sm btn-active-icon-primary">
                ...
                <VForm @submit="submit()" :model="formData" ref="formRef">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_update_details_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_details_header" data-kt-scroll-wrappers="#kt_modal_update_details_scroll" data-kt-scroll-offset="300px">
                            <!--Name-->
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-semibold mb-2">{{ $t('user.label.name') }}</label>
                                <Field type="text" :placeholder="$t('user.placeholder.name')" class="form-control form-control-lg form-control-solid" name="name" v-model="formData.name"/>
...
const submit = () => {
    const url = route('users.updateDetails', props.user?.id);
    formData.patch(url, {
        preserveScroll: true,
        onSuccess: () => {
